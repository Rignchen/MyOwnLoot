function itemio:v0.12.1/generator/set_storage
...
function itemio:v0.12.1/generator/stack_loop
...
function itemio:v0.12.1/generator/add_end with storage itemio:main temp
