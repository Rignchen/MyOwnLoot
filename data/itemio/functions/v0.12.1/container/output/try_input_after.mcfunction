...
execute as @e[tag=itemio.transfer.destination.good_distance, limit=1, sort=nearest] at @s run function itemio:v0.12.1/container/output/try_input_after/loop
