...
execute if score #filters.valid_item itemio.io matches 1 run function itemio:v0.12.1/container/output/vanilla/output/process with storage itemio:main.output temp.args_loop_item
