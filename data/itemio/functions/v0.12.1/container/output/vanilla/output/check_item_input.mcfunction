...
execute if score #!same_item itemio.math.output matches 0 run function itemio:v0.12.1/container/output/vanilla/output/process with storage itemio:main.output temp.args_loop_item
